  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
        <h3 className="text-gray-900 dark:text-gray-100 mb-4">Попередній перегляд</h3>
        <div 
          className="h-40 rounded-xl border-2 border-gray-200 dark:border-gray-700 p-4 flex items-center justify-center"
          style={{ 
            background: user.customBackground || 'linear-gradient(135deg, #f5f3ff 0%, #e9d5ff 100%)',
            backgroundSize: 'cover',
            backgroundPosition: 'center'
          }}
        >
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            <p className="text-gray-900 dark:text-gray-100">Так виглядатиме твій додаток</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">З обраними налаштуваннями</p>
          </div>
        </div>
      </div>
